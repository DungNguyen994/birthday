...
const Birthday = () => {
  ...
  useEffect(() => {
    ...
    class Birthday {
      ...
      resize() {
        this.width = canvasRef.current.width = window.innerWidth;
        let center = (this.width / 2) | 0;
        this.spawnA = (center - center / 4) | 0;
        this.spawnB = (center + center / 4) | 0;

        this.height = canvasRef.current.height = window.innerHeight;
    ...
    return () => {
      ...
      document.removeEventListener("click", (evt) => birthday.onClick(evt));
      document.removeEventListener("touchstart", (evt) =>
